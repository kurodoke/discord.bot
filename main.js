...
const fsRead = fs.readdirSync(`./commands/`).filter(files => files.endsWith('.js'));
...
client.on("message", async message => {
  ...
  const cmd = client.commands.get(command) || client.commands.find(cmd => cmd.alliases && cmd.alliases.includes(command))
  if (cmd) {
